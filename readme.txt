The codes folder contains following files:

Data Generation Matlab codes
...
Top3D_maxbulk.m - topology optimization code for objective function of maximum Bulk modulus.Taken from [1] and modified.
Top3D_maxshear.m - topology optimization code for objective function of maximum Shear modulus.Taken from [1] and modified.

MATLAB Data files
initialDes.mat - contains initial topology density of a Gyroid with 32x32x32 voxels of volume fraction ~58%.Generated from [2].
